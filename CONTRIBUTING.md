Contributing to syk Core
============================

The syk Core project operates an open contributor model where anyone is
...
The following applies to code changes to the syk Core project, and is not to be
confused with overall syk Network Protocol consensus changes.

Whether a pull request is merged into syk Core rests with the project merge
...
Patches that change syk consensus rules are considerably more involved than
...
Where a patchset proposes to change the syk consensus, it must have been
...
The project leader is the release manager for each syk Core release.
