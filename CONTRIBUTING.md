Contributing to sykcoin Core
============================

The sykcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/sykcoin-project/sykcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the sykcoin Core project, and is not to be
confused with overall sykcoin Network Protocol consensus changes.

Whether a pull request is merged into sykcoin Core rests with the project merge
...
Patches that change sykcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the sykcoin consensus, it must have been
...
The project leader is the release manager for each sykcoin Core release.
