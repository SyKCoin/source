...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='syk.conf'
CONFIGFOLDER='/root/.syk'
COIN_DAEMON='sykd'
COIN_CLI='syk-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/syk/syk/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
