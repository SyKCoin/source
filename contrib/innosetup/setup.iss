...
#define MyAppName "syk Core"
#define MyAppPublisher "2021-2022 The syk Developers"
#define MyAppURL "https://github.com/sykcoin/source"
#define MyAppExeName "syk-qt.exe"
#define MyAppExtraData "https://github.com/sykcoin/source/releases/download/v2.0/bootstrap.zip"
...
AppId={{617574C1-BE75-4E52-B768-21A3D3FA496F}
AppName={#MyAppName}
...
[Files]
Source: ".\package\syk-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\syk\syk-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\syk\syk-Qt,strDataDir|{userappdata}\syk\}');
  Result := True;
end;
