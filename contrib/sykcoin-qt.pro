...
RESOURCES += src/qt/sykcoin.qrc src/qt/sykcoin_locale.qrc

TRANSLATIONS += src/qt/locale/sykcoin_bg.ts \
                src/qt/locale/sykcoin_de.ts \
                src/qt/locale/sykcoin_en.ts \
                src/qt/locale/sykcoin_es.ts \
                src/qt/locale/sykcoin_fi.ts \
                src/qt/locale/sykcoin_fr.ts \
                src/qt/locale/sykcoin_it.ts \
                src/qt/locale/sykcoin_ja.ts \
                src/qt/locale/sykcoin_pl.ts \
                src/qt/locale/sykcoin_pt.ts \
                src/qt/locale/sykcoin_ru.ts \
                src/qt/locale/sykcoin_sk.ts \
                src/qt/locale/sykcoin_sv.ts \
                src/qt/locale/sykcoin_vi.ts \
                src/qt/locale/sykcoin_zh_CN.ts \
                src/qt/locale/sykcoin_zh_TW.ts
