...
syk.conf           | contains configuration settings for sykd or syk-qt
sykd.pid           | stores the process id of sykd while running
...
debug.log           | contains debug information and general logging generated by sykd or syk-qt
