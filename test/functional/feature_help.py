...
"""Verify that starting syk with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start syk with -? for help text")
        ...
        self.log.info("Start syk with -version for version information")
