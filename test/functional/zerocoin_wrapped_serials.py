...
from fake_stake.base_test import sykcoin_FakeStakeTest

class zSYKwrappedSerialsTest(sykcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSYKs..." % DENOM_TO_USE)
