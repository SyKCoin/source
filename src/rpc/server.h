...
/**
 * sykcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZsykSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzsykseed(const UniValue& params, bool fHelp);
extern UniValue getzsykseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsyk(const UniValue& params, bool fHelp);
extern UniValue dzsykstate(const UniValue& params, bool fHelp);
