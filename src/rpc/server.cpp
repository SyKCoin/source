...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "sykcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* sykcoin features */
        {"sykcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"sykcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sykcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sykcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"sykcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"sykcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"sykcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sykcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"sykcoin", "startmasternode", &startmasternode, true, true, false},
        {"sykcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sykcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sykcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sykcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sykcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sykcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sykcoin", "preparebudget", &preparebudget, true, true, false},
        {"sykcoin", "submitbudget", &submitbudget, true, true, false},
        {"sykcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sykcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sykcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sykcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sykcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sykcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sykcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sykcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"sykcoin", "mnsync", &mnsync, true, true, false},
        {"sykcoin", "spork", &spork, true, true, false},
        {"sykcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsykseed", &getzsykseed, false, false, true},
        {"zerocoin", "setzsykseed", &setzsykseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsyk", &searchdzsyk, false, false, true},
        {"zerocoin", "dzsykstate", &dzsykstate, false, false, true},
...
{
    return "> sykcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:4467/\n";
}
