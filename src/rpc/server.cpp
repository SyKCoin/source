...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* syk features */
        {"syk", "listmasternodes", &listmasternodes, true },
        {"syk", "getmasternodecount", &getmasternodecount, true },
        {"syk", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"syk", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"syk", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"syk", "masternodecurrent", &masternodecurrent, true },
        {"syk", "startmasternode", &startmasternode, true },
        {"syk", "createmasternodekey", &createmasternodekey, true },
        {"syk", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"syk", "listmasternodeconf", &listmasternodeconf, true },
        {"syk", "getmasternodestatus", &getmasternodestatus, true },
        {"syk", "getmasternodewinners", &getmasternodewinners, true },
        {"syk", "getmasternodescores", &getmasternodescores, true },
        {"syk", "mnsync", &mnsync, true },
        {"syk", "spork", &spork, true },
...
{
    return "> syk-cli " + methodname + " " + args + "\n";
}
