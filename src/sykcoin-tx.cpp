...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("sykcoin Core sykcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sykcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sykcoin transaction") + "\n" +
                               "  sykcoin-tx [options] -create [commands]   " + _("Create hex-encoded sykcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sykcoin transaction
