...
#ifndef sykcoin_ZSYKWALLET_H
#define sykcoin_ZSYKWALLET_H
...
public:
    CzSYKWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSYK(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSYK(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
