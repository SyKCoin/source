...
#ifndef sykcoin_ZSYKTRACKER_H
#define sykcoin_ZSYKTRACKER_H
...
public:
    CzSYKTracker(std::string strWalletFile);
    ~CzSYKTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSYKWallet* zSYKWallet = NULL);
