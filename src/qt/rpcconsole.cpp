                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSYKPathCustom = GetArg("-zsykbackuppath", "");
    ...
    if(!strzSYKPathCustom.empty()) {
        ui->wallet_customzsykbackuppath->setText(QString::fromStdString(strzSYKPathCustom));
        ui->wallet_customzsykbackuppath_label->setVisible(true);
        ui->wallet_customzsykbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSYKPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the sykcoin RPC console.") + "<br>" +
