...
/* sykcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "sykcoin"
#define QAPP_ORG_DOMAIN "sykcoin.org"
#define QAPP_APP_NAME_DEFAULT "sykcoin-Qt"
#define QAPP_APP_NAME_TESTNET "sykcoin-Qt-testnet"
