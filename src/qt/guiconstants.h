...
/* syk GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "syk"
#define QAPP_ORG_DOMAIN "syk.org"
#define QAPP_APP_NAME_DEFAULT "syk-Qt"
#define QAPP_APP_NAME_TESTNET "syk-Qt-testnet"
