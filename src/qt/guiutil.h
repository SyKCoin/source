...
/** Utility functions used by the sykcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render sykcoin addresses in monospace font
...
// Parse "sykcoin:" URI into recipient object, return true on successful parsing
