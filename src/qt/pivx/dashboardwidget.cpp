    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of syk earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 syk");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair syk
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(0,174,229));
	set1->setColor(QColor(27,56,84));
