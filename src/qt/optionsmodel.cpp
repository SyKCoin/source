...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SYK);
...
// Wallet
    ...
    if (settings.contains("nAnonymizesykcoinAmount"))
        SoftSetArg("-anonymizesykcoinamount", settings.value("nAnonymizesykcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in sykcoin.cpp during shotdown to also remove the window positions
