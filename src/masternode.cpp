...
{
    if (nHeight >   13000000) return            0 * COIN;
    if (nHeight >   12000000) return   0.00244141 * COIN;
    if (nHeight >   11000000) return   0.00488281 * COIN;
    if (nHeight >   10000000) return   0.00976563 * COIN;
    if (nHeight >   9000000) return    0.01953215 * COIN;
    if (nHeight >   8000000) return     0.0390625 * COIN;
    if (nHeight >   7000000) return      0.078125 * COIN;
    if (nHeight >   6000000) return       0.15625 * COIN;
    if (nHeight >   5000000) return        0.3125 * COIN;
    if (nHeight >   4000000) return         0.625 * COIN;
    if (nHeight >   3000000) return          1.25 * COIN;
    if (nHeight >   2000000) return           2.5 * COIN;
    if (nHeight >   1000000) return             5 * COIN;
    if (nHeight >     15000) return            10 * COIN;
...
{																		 
    if(nHeight > 250) return GetBlockValue(nHeight) * 70 / 100;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 syk tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 syk tx -> 1 confirmation
