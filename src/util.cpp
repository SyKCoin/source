...
const char * const PIVX_CONF_FILENAME = "syk.conf";
const char * const PIVX_PID_FILENAME = "syk.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\syk
// Windows >= Vista: C:\Users\Username\AppData\Roaming\syk
// Mac: ~/Library/Application Support/syk
// Unix: ~/.syk
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "syk";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty syk.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=4467\naddnode=seed1.sykcoin.com:4468\naddnode=seed2.sykcoin.com:4468\naddnode=seed3.sykcoin.com:4468\naddnode=seed4.sykcoin.com:4468\naddnode=seed5.sykcoin.com:4468\naddnode=seed6.sykcoin.com:4468\naddnode=seed7.sykcoin.com:4468\naddnode=seed8.sykcoin.com:4468\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override syk.conf
